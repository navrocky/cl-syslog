...
#ifdef _MSC_VER
#define CHECKPOINT LOG_DEBUG << "Checkpoint at " << __FUNCSIG__ << ":" << __LINE__
#else
#define CHECKPOINT LOG_DEBUG << "Checkpoint at " << __PRETTY_FUNCTION__ << ":" << __LINE__
#endif
...
#define LOG_SUPPRESS_EXCEPTIONS \
    catch(const std::exception& e){LOG_ERR << e.what();}catch(...){LOG_ERR << "Unknown error";}
